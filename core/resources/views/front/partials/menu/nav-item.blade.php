...
<div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            ...
            @endif" href="{{ route('front.service') }}">Courses</a>
        </li>
        @endif
        ...
        <li class="nav-item">
            ...
            @endif" href="{{ route('front.portfolio') }}">Events</a>
        </li>
        @endif
        <li class="nav-item">
            <a class="nav-link  
...
<div class="navbar-btn mr-100 ml-30 d-none d-lg-block">
    <a class="main-btn" href="{{ route('front.quot') }}">{{ __('Apply for Admission') }} <i class="fal fa-long-arrow-right"></i></a>
</div>
@endif