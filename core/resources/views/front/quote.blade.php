		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-title-item text-center">
					<h2 class="title">{{ __('Apply Now') }}</h2>
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="{{ route('front.index') }}">{{ __('Home') }} </a></li>
							<li class="breadcrumb-item active" aria-current="page">{{ __('Apply Now') }}</li>
						</ol>
					</nav>
				</div> <!-- page title -->
			</div>
            ...
            <div class="col-lg-12">
                <form action="{{ route('front.quote_submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="input-box mb-20">
                                <input type="text"  placeholder="Address" name="country" value="{{ old('country') }}">
                        ...
                        <div class="col-lg-6">
                            <div class="input-box mb-20">
                                <input type="text"  placeholder="{{ __('Admission Grade') }}" name="budget" value="{{ old('budget') }}">
                            </div> <!-- input box -->
                        ...
                        <div class="col-lg-6">
                            <div class="input-box mb-20">
                                <input type="text"  placeholder="{{ __('Previous School') }}" name="skypenumber" value="{{ old('skypenumber') }}">
                        ...
                        <div class="col-lg-12">
                            <div class="input-box text-center mb-20">
                                <textarea name="description"  id="#" cols="30" rows="10" placeholder="{{ __('Study Description') }} *">{{ old('description') }}</textarea>
