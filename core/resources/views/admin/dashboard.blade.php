    ...
    <div class="row">
      ...
      {{-- <div class="col-md-4 col-sm-6 col-12">
        <div class="info-box bg-gradient-info">
          ...
          <div class="info-box-content">
            ...
            <h4 class="info-box-number font-weight-normal">{{$currentLang->contact()->count()}}</h4>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-4 col-sm-6 col-12">
        <div class="info-box bg-gradient-warning">
          ...
          <div class="info-box-content">
            <span class="info-box-text">{{ __('Admissions') }}</span>
      ...
      <div class="col-md-12">
        <div class="card card-primary card-outline">
          <div class="card-header">
            <h3 class="card-title">{{ __('Latest Admission Requests:') }}
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="idtable" class="table table-bordered table-striped data_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="mailto:{{ $quote->email }}" class="btn btn-primary btn-sm"><i
                        class="fas fa-paper-plane"></i> {{ __('Send Mail') }}</a>
                  </td>

                  <td>
                    <a class="btn btn-info btn-sm" href="{{ route('admin.quote.details', $quote->id) }}"><i
                        class="fas fa-eye"></i>{{ __('Details') }}</a>
                    <form id="deleteform" class="d-inline-block" action="{{ route('admin.quote.delete', $quote->id ) }}"
                      method="post">
                      @csrf
