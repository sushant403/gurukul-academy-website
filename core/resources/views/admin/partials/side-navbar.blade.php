...
<aside class="main-sidebar elevation-4 main-sidebar elevation-4 sidebar-light-primary">
    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li class="nav-item 
                    ...
                    <a href="#" class="nav-link @if(request()->path() == 'admin/all/quote') active 
                        ...
                        <p>
                            {{ __('Admission Request') }}
                            <i class="fas fa-angle-left right"></i>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.all.quote') }}"
                                class="nav-link  @if(request()->path() == 'admin/all/quote') active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('All Admission') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.pending.quote') }}"
                                class="nav-link  @if(request()->path() == 'admin/pending/quote') active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('Pending Admission') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.processing.quote') }}"
                                class="nav-link  @if(request()->path() == 'admin/processing/quote') active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('Processing Admission') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.completed.quote') }}"
                                class="nav-link  @if(request()->path() == 'admin/completed/quote') active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('Completed Admission') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.rejected.quote') }}"
                                class="nav-link  @if(request()->path() == 'admin/rejected/quote') active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('Rejected Admission') }}</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item ]
                            ...
                            <ul class="nav nav-treeview 
                                    ...
                                    ">
                                <li class="nav-item">
                                    <a href="{{ route('admin.mail.config') }}"" class=" nav-link @if(request()->path()
                                        == 'admin/email-config') active @endif
                                        ">
            ...
            @if (empty($admin->role) || (!empty($permissions) && in_array('About', $permissions)))
            <li class="nav-item">
