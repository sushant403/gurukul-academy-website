...
<aside class="main-sidebar elevation-4 main-sidebar elevation-4 sidebar-light-primary">
    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.announcement.index'). '?language=' . $lang_code); ?>"
                        ...
                        <i class="far fa-mobile nav-icon"></i>
                        <p><?php echo e(__('Notice Announcement')); ?></p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.basicinfo'). '?language=' . $lang_code); ?>"
                        ...
                        <p><?php echo e(__('School Information')); ?></p>
                    </a>
                </li>
                ...
                <li class="nav-item 
                    ...
                    <a href="#" class="nav-link <?php if(request()->path() == 'admin/all/quote'): ?> active 
                        ...
                        <p>
                            <?php echo e(__('Admission Request')); ?>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.all.quote')); ?>"
                                class="nav-link  <?php if(request()->path() == 'admin/all/quote'): ?> active <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('All Admission')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.pending.quote')); ?>"
                                class="nav-link  <?php if(request()->path() == 'admin/pending/quote'): ?> active <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Pending Admission')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.processing.quote')); ?>"
                                class="nav-link  <?php if(request()->path() == 'admin/processing/quote'): ?> active <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Processing Admission')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.completed.quote')); ?>"
                                class="nav-link  <?php if(request()->path() == 'admin/completed/quote'): ?> active <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Completed Admission')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.rejected.quote')); ?>"
                                class="nav-link  <?php if(request()->path() == 'admin/rejected/quote'): ?> active <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Rejected Admission')); ?></p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item ]
                            ...
                            <ul class="nav nav-treeview 
                                    ...
                                    ">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('admin.mail.config')); ?>"" class=" nav-link <?php if(request()->path()
                                        == 'admin/email-config'): ?> active <?php endif; ?>
                                        ">
                ...
                <li class="nav-item
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            ...
                            ">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Events Section')); ?></p>
                            </a>
                        </li>
            ...
            <?php if(empty($admin->role) || (!empty($permissions) && in_array('About', $permissions))): ?>
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.blog'). '?language=' . $lang_code); ?>" class="nav-link
                                    ...
                                    <?php endif; ?>">
                            <i class="far fa-circle nav-icon"></i>
                            <p><?php echo e(__('Write new Blog')); ?></p>
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\laragon\www\gurukul\core\resources\views/admin/partials/side-navbar.blade.php ENDPATH**/ ?>