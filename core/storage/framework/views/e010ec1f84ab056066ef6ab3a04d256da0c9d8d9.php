        ...
        <div class="row">
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                    <form class="form-horizontal" action="<?php echo e(route('admin.counter.update', $counter->id)); ?>" method="POST" >
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control lang" name="language_id">
                                                    <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($lang->id); ?>" <?php echo e($counter->language_id == $lang->id ? 'selected' : ''); ?> ><?php echo e($lang->name); ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="title" placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e($counter->title); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="number" placeholder="<?php echo e(__('Number')); ?>" value="<?php echo e($counter->number); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="icon" placeholder="<?php echo e(__('Icon')); ?>" value="<?php echo e($counter->icon); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="text" class="form-control"  rows="3" placeholder="<?php echo e(__('Content')); ?>"><?php echo e($counter->text); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="serial_number" placeholder="<?php echo e(__('Order')); ?>" value="<?php echo e($counter->serial_number); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="status">
                                                   <option value="0" <?php echo e($counter->status == '0' ? 'selected' : ''); ?>><?php echo e(__('Unpublish')); ?></option>
                                                   <option value="1" <?php echo e($counter->status == '1' ? 'selected' : ''); ?>><?php echo e(__('Publish')); ?></option>
                                                  </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gurukul\core\resources\views/admin/home/counter/edit.blade.php ENDPATH**/ ?>